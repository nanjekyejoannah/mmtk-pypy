...
pub struct MutatorClosure {
    pub func: extern "C" fn(mutator: *mut Mutator<PyPy>, data: *mut libc::c_void),
...
pub static FREE_LIST_ALLOCATOR_SIZE: uintptr_t =
    std::mem::size_of::<mmtk::util::alloc::FreeListAllocator<PyPy>>();
...
pub static MMTK_MARK_COMPACT_HEADER_RESERVED_IN_BYTES: usize =
    mmtk::util::alloc::MarkCompactAllocator::<PyPy>::HEADER_RESERVED_IN_BYTES;
